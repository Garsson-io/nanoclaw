 ...
 *     - case-sync.ts for cloud sync (GitHub Issues V1, swappable)
 *     - case-auth.ts for authorization decisions
 *     - github-issues.ts for dev case issue creation (kaizen repo)
 *
 * Separation of concerns:
 *   - ipc.ts: dispatch routing, file watching, non-case IPC
 *   - ipc-cases.ts (this file): case lifecycle business logic
 *   - case-sync.ts + case-sync-github.ts: cloud backend adapter
